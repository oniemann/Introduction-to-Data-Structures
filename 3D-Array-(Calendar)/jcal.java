//$Id: jcal.java,v 1.9 2015-01-20 21:27:05-08 okeefe - $
            ...
            for(int week = 0; week < WEEKS_IN_MONTH; week++) {
                ...
                while (k < 3) {
                    ...
                    while (day < 7) {
                        ...
                        //else if(week == 5 && currentYear[month-1][week][day] == 0 && day == 0)
                        //    out.printf("  ");
                    ...
                    //puts three spaces between weeks
                    if(k != 2 && en == false)
                        out.printf(day == 0 ? "  " : "   ");
                    month++;
                    k++;
