...
//
// Doubles hashset memory allocation
//
hashset *array_double (hashset*);

hashset *copy_hash (hashset*, hashset*);
//
...
//
// Debug printout of hastset statistics
//
void dumpstats(hashset*);
void dump_hashset(hashset*);
